      ...
      <div className="col-12 col-lg-8">
        <CardGroup className="justify-content-center">
          {filteredTasks.map((task) => (
            <div className="col-12 col-md-6 mb-3" key={task._id}>
              <Card className={`mx-3 ${task.complete === 'completada' ? 'bg-success text-white' : 'bg-danger text-white'}`}>
                <Card.Body>
                ...
                <Card.Footer className="d-flex justify-content-center bg-light mt-2">
